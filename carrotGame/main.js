...
const BUG_NUMBER = 5;
const CARROT_IMAGE = './img/carrot.png';
const BUG_IMAGE = './img/bug.png';
const IMAGE_SIZE = 80;
...
const soundBugPull = new Audio('./sound/bug_pull.mp3');
const soundCarrotPull = new Audio('./sound/carrot_pull.mp3');
const soundGameWin = new Audio('./sound/game_win.mp3');
